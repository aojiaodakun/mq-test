package com.hzk.springboot.producer;
...
//		rabbitTemplate.convertandsend("",Object);
	...
	/**
	 * http://localhost:8080/batchSend?message=hello
	 */
	@ApiOperation(value="batch发送接口",notes="批量发送到队列")
	@GetMapping(value="/batchSend")
	public Object batchSend(String message) throws AmqpException, UnsupportedEncodingException {
		for (int i = 0; i < 20; i++) {
			String newMessage = message + i;
			batchingRabbitTemplate.convertAndSend("batchQueue", newMessage);
		}
		return "success";
	}
