...
public class RocketMQTopicUtil {
    ...
    public static boolean createTopic(String topic, int queueNums) {
        ...
        try {
            String clusterName = System.getProperty("clusterName","DefaultCluster");
    ...
    public static Map<String, Set<String>> getAllCluster(MQAdminExt mqAdminExt) throws Exception{
        ClusterInfo clusterInfoSerializeWrapper = mqAdminExt.examineBrokerClusterInfo();
        Map<String, Set<String>> clusterAddrTable = clusterInfoSerializeWrapper.getClusterAddrTable();
